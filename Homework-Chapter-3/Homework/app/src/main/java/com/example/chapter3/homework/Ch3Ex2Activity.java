...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animatorX = ObjectAnimator.ofFloat(target,"ScaleX",2f,1f);
        ObjectAnimator animatorY = ObjectAnimator.ofFloat(target,"ScaleY",2f,1f);
        ...
        animatorSet.playTogether(animator1,animatorX,animatorY,animatorAlpha);
        animatorSet.start();
