    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loopCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    Log.i("Ch3Ex1_lottie","Start playing");
                } else {
                    // 当去除自动播放时，停止播放 lottie 动画，同时允许手动修改进度
                    animationView.pauseAnimation();
                    seekBar.setEnabled(true);
                    Log.i("Ch3Ex1_lottie","Stop playing");
                }
            }
        });
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                animationView.setProgress((float) progress/(float)seekBar.getMax());
                Log.i("Ch3Ex1_SeekBar",String.valueOf((float)progress/(float)seekBar.getMax()));
            }
