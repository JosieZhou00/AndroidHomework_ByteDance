package com.bytedance.component.finalproject.activity;
...
import com.bytedance.component.finalproject.R;
import com.bytedance.component.finalproject.net.UploadResponse;
import com.bytedance.component.finalproject.utils.Constants;
import com.bytedance.component.finalproject.utils.IApi;
    ...
    private void upload() {
        ...
        resp.enqueue(new Callback<UploadResponse>() {
            ...
            public void onResponse(final Call<UploadResponse> call, final Response<UploadResponse> response) {
                ...
                Toast.makeText(ChooseCoverActivity.this, R.string.uplaod_success, Toast.LENGTH_SHORT).show();
                finish();
            }
            ...
            public void onFailure(final Call<UploadResponse> call, final Throwable t) {
                t.printStackTrace();
                Toast.makeText(ChooseCoverActivity.this, getString(R.string.upload_fail), Toast.LENGTH_SHORT).show();
