package com.bytedance.component.finalproject.view;
...
public class LikeAnimationView extends RelativeLayout {
    ...
    public LikeAnimationView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    public LikeAnimationView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
